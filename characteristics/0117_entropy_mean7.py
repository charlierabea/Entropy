            ...
            for status in ['inactive', 'active']:
                ...
                for file in os.listdir(os.path.join(pre_dir, status)):
                    if file.startswith(str(patient_number) + "_"):
                        ...
                        entropy = util2.calculate_image_entropy(full_image_path)
                        
                        # Store the entropy value in the DataFrame
                        results_df.at[index, f'{status}_{dirname}'] = entropy
                        # break
...
results_df.to_excel('/raid/jupyter-charlielibear.md09-24f36/entropy/excel/mean7_entropy.xlsx')
