            ...
            for status in ['inactive', 'active']:
                ...
                for file in os.listdir(os.path.join(pre_dir, status)):
                    if file.startswith(str(patient_number) + "_"):
                        ...
                        bvd = util2.calculate_bvd(full_image_path)
                        
                        # Store the entropy value in the DataFrame
                        results_df.at[index, f'{status}_{dirname}'] = bvd
...
results_df.to_excel('/raid/jupyter-charlielibear.md09-24f36/entropy/excel/biomarker_bvd/mean7_bvd.xlsx')
