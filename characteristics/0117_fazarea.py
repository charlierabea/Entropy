            ...
            for status in ['inactive', 'active']:
                ...
                for file in os.listdir(os.path.join(pre_dir, status)):
                    if file.startswith(str(patient_number) + "_"):
                        ...
                        area = util2.calculate_faz_ci(img)[0]
                        
                        # Store the entropy value in the DataFrame
                        results_df.at[index, f'{status}_{dirname}'] = area
                        break
...
results_df.to_excel('/raid/jupyter-charlielibear.md09-24f36/entropy/excel/fazarea/0117_fazarea.xlsx')
